 ...
 */
class getBiereRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BiereRepository' shared autowired service.
     *
     * @return \App\Repository\BiereRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BiereRepository.php';

        return $container->privates['App\\Repository\\BiereRepository'] = new \App\Repository\BiereRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
