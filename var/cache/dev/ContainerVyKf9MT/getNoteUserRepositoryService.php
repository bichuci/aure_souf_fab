 ...
 */
class getNoteUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NoteUserRepository' shared autowired service.
     *
     * @return \App\Repository\NoteUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NoteUserRepository.php';

        return $container->privates['App\\Repository\\NoteUserRepository'] = new \App\Repository\NoteUserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
