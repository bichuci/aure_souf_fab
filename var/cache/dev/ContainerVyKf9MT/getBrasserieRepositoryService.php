 ...
 */
class getBrasserieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BrasserieRepository' shared autowired service.
     *
     * @return \App\Repository\BrasserieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BrasserieRepository.php';

        return $container->privates['App\\Repository\\BrasserieRepository'] = new \App\Repository\BrasserieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
