 ...
 */
class getCommentaireUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommentaireUserRepository' shared autowired service.
     *
     * @return \App\Repository\CommentaireUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommentaireUserRepository.php';

        return $container->privates['App\\Repository\\CommentaireUserRepository'] = new \App\Repository\CommentaireUserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
